...
\subsubsection*{Aside: sqrt(2) is irrational}\label{sqrt2proof}
...
\begin{itemize}
\item Obviously $\mathcal{R}$ is a dense subset of itself (if
  $x,y\in\mathcal{R}$ then $\frac{x+y}{2}\in(x,y)$).
